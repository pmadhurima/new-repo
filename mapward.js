...
function init() {
    ...
    var geometry = new THREE.CubeGeometry( 5, 10, 1);
    
    var material = new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture('maptexture.jpg') } );

    contorls = new THREE.OrbitControls(camera);
    contorls.addEventListener('change',animate);
